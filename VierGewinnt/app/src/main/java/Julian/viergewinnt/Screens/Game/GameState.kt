...
class GameState {
    ...
    companion object {
        fun isValidMove(board: Array<Array<Pair<Button, Int>>>, col: Int): Boolean { // checks if there is an empty field
            for (x in 0 .. 5) {
                if (board[x][col].second == 0) {
                    return true
                }
            }
            return false
        ...
        fun rowOfDeepestField(board: Array<Array<Pair<Button, Int>>>, col: Int): Int { // returns deepest field that is empty
            for (x in 0 .. 5) {
                if (board[x][col].second == 0) {
                    return x
                }
        ...
        fun isDraw(board: Array<Array<Pair<Button, Int>>>): Boolean {
            for (r in 0..5) {
                for (c in 0..6) {
        ...
        fun isWIN(board: Array<Array<Pair<Button, Int>>>, activePlayer: Int): Boolean {
            var winCounter = 0
            // Check for rows
            for (r in 0..5) {
                for (c in 0..6) {
                    if (board[r][c].second == activePlayer) {
                        winCounter++
                    } else {
                        winCounter = 0
                    }
